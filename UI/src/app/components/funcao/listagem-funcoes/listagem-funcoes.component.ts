...
export class ListagemFuncoesComponent implements OnInit {
  ...
  AbrirDialog(funcaoId: any, nome: any) {
    this.dialog.open(DialogExclusaoComponent,{
      data: {
        funcaoId: funcaoId,
        nome: nome
      }
...
export class DialogExclusaoComponent{
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, private funcoesService: FuncoesService, private snackBar: MatSnackBar){}
