...
export class ListagemCartoesComponent implements OnInit {
  ...
  autoCompleteInput: any = new FormControl();
  ...
  FiltrarCartoes(numero: any): string[] {
  ...
  AbrirDialog(cartaoId: any, numero: any) {
...
export class DialogExclusaoCartoesComponent {
  constructor(@Inject(MAT_DIALOG_DATA) public data: any, private cartoesService: CartoesService, private snackBar: MatSnackBar) { }
